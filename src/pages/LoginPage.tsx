        ...
        <div className="max-w-[440px] w-full">
          <div className="bg-white dark:bg-slate-900 rounded-[32px] shadow-2xl shadow-slate-200/50 dark:shadow-none border border-slate-100 dark:border-slate-800 overflow-hidden transition-colors">
            <div className="p-10">
              ...
              <p className="text-sm font-bold text-center text-slate-400 dark:text-slate-500 mb-6">
              ...
              <form onSubmit={handleVerifyMfa} className="space-y-6">
                ...
                <button
                  ...
                  className="w-full text-center  font-black text-slate-400 hover:text-slate-600 dark:hover:text-slate-300 uppercase tracking-widest"
                >
        ...
        <div className="max-w-[440px] w-full">
          <div className="bg-white dark:bg-slate-900 rounded-[32px] shadow-2xl shadow-slate-200/50 dark:shadow-none border border-slate-100 dark:border-slate-800 overflow-hidden transition-colors">
            <div className="p-10">
              ...
              <p className="text-sm text-center dark:text-slate-500 mb-8">
              ...
              <form onSubmit={handleVerifyMfa} className="space-y-6">
                ...
                <button
                  ...
                  className="w-full text-center hover:text-blue-600 dark:hover:text-slate-300 uppercase tracking-widest cursor-pointer"
                >
                  Cancel setup & Sign Out
                </button>
              </form>
    ...
    <div className="min-h-screen bg-[#f8fafc] dark:bg-slate-950 flex items-center justify-center p-4 transition-colors">
      <div className="max-w-[440px] w-full">
        ...
        <div className="flex flex-col items-center mb-10">
            ...
            <img
              ...
              onError={(e) => {
                ...
                e.currentTarget.parentElement!.innerHTML =
                  '<svg class="w-10 h-10 text-white" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/></svg>';
              }}
            />
          </div>
          ...
          <p className="text-sm dark:text-slate-500 font-black tracking-[0.2em] mt-2">
        ...
        <div className="bg-white dark:bg-slate-900 rounded-[32px] shadow-2xl shadow-slate-200/50 dark:shadow-none border border-slate-100 dark:border-slate-800 overflow-hidden transition-colors">
            ...
            <form onSubmit={handleLogin} className="space-y-6">
              {error && (
                <div className="bg-red-50 dark:bg-red-900/20 border border-red-100 dark:border-red-900/30 text-red-600 dark:text-red-400 p-4 rounded-2xl flex items-start gap-3 animate-in fade-in slide-in-from-top-1">
                  <AlertCircle className="w-5 h-5 shrink-0 mt-0.5" />
                  <p className="text-sms leading-relaxed">{error}</p>
                </div>
              )}

              <div className="space-y-2">
                <label className="text-sm dark:text-slate-500 tracking-widest ml-1">
                  Email Address
                </label>
                <div className="relative">
                  <Mail className="absolute left-4 top-1/2 -translate-y-1/2 w-5 h-5 dark:text-slate-700" />
                  <input
                    required
                    type="email"
              ...
              <div className="space-y-2">
                <div className="ml-1">
                  <label className="text-sm dark:text-slate-500 tracking-widest">
                    Password
                  </label>
                </div>
                <div className="relative">
                  <Lock className="absolute left-4 top-1/2 -translate-y-1/2 w-5 h-5 dark:text-slate-700" />
                  <input
                    required
                    type="password"
                    placeholder="••••••••"
              ...
              <div className="flex items-center justify-between px-1">
                <label className="flex items-center gap-2 cursor-pointer group">
                  ...
                  <span className="text-sm dark:text-slate-500 tracking-widest group-hover:text-slate-600 dark:group-hover:text-slate-300 transition-colors">
                    Remember Me
                  </span>
                </label>
                <Link
                  to="/forgot-password"
                  className="text-sm text-blue-600 dark:text-blue-400 tracking-widest hover:underline"
                >
                  Forgot Password?
                </Link>
              </div>
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full bg-blue-600 text-white py-4 rounded-2xl font-black tracking-widest hover:bg-blue-700 shadow-lg shadow-blue-200 dark:shadow-none disabled:opacity-50 transition-all active:scale-[0.98] flex items-center justify-center gap-2 group"
              >
                {loading ? (
                  <Loader2 className="w-5 h-5 animate-spin" />
                ) : (
          ...
          <div className="bg-slate-50 dark:bg-slate-800/50 p-6 border-t border-slate-100 dark:border-slate-800 flex flex-col items-center justify-center gap-3">
            <p className="text-xs text-slate-400 dark:text-slate-500 tracking-widest text-center leading-relaxed">
