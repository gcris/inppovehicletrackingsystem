    ...
    <div className="min-h-screen bg-[#f8fafc] flex items-center justify-center p-4">
      <div className="max-w-[440px] w-full">
        <div className="flex flex-col items-center mb-10">
          ...
          <h1 className="text-3xl font-black text-slate-900 tracking-tighter">SECURE ACCESS</h1>
        </div>
            ...
            {success ? (
              <div className="text-center py-6">
                ...
                <p className="text-sm font-bold text-slate-400 mb-8 leading-relaxed">
                  We've sent a passkey recovery link to <span className="text-slate-900 font-extrabold">{email}</span>
                </p>
                <Link
                  to="/login"
              ...
              <>
                <div className="mb-8">
                  <h2 className="text-2xl font-black text-slate-900 mb-2">Account Recovery</h2>
                  <p className="text-sm font-bold text-slate-400">Provide your verified email to reset your passkey</p>
                </div>
                ...
                <form onSubmit={handleReset} className="space-y-6">
                  ...
                  <button
                    type="submit"
                    disabled={loading}
                    className="w-full bg-slate-900 text-white py-4 rounded-2xl font-black uppercase tracking-widest hover:bg-slate-800 shadow-xl shadow-slate-200 disabled:opacity-50 transition-all active:scale-[0.98] flex items-center justify-center gap-2"
                  >
                    {loading ? (
