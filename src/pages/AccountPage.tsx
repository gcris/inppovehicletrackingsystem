    ...
    <div className="flex flex-col gap-8 max-w-4xl mx-auto w-full py-8">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-slate-500 dark:text-slate-400 font-bold uppercase tracking-wider mt-1">
            ...
            <div className="flex items-center gap-6">
              ...
              <div>
                ...
                <div className="flex items-center gap-4 mt-2">
                  <div className="flex items-center gap-1.5 px-2.5 py-1 bg-green-50 dark:bg-green-900/20 text-green-600 dark:text-green-400 rounded-full  font-black uppercase tracking-wider">
                    <ShieldCheck className="w-3 h-3" />
                    {isAdmin ? "Central Admin" : "Verified Operator"}
                  </div>
                  <span className="text-xs font-bold text-slate-400 dark:text-slate-500">
                    ID: {profile?.badge_number || user?.id.slice(0, 8)}
                  </span>
                </div>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pt-4">
              <div className="space-y-1.5">
                ...
                <div className="flex items-center gap-3 p-4 bg-slate-50 dark:bg-slate-800/30 rounded-2xl border border-slate-100 dark:border-slate-800 transition-colors">
                  ...
                  <span className="text-sm font-bold text-slate-700 dark:text-slate-300">
                    {profile?.rank?.rank_name || "No Rank Set"}
                  </span>
                </div>
              </div>
              <div className="space-y-1.5">
              ...
              <div className="space-y-1.5">
                ...
                <div className="flex items-center gap-3 p-4 bg-slate-50 dark:bg-slate-800/30 rounded-2xl border border-slate-100 dark:border-slate-800 transition-colors">
                  ...
                  <span className="text-sm font-bold text-slate-700 dark:text-slate-300 uppercase">
                    {user?.app_metadata?.provider || "Auth Service"}
                  </span>
                </div>
              </div>
            </div>
        ...
        <div className="space-y-6">
          <div className="bg-slate-900 dark:bg-slate-950 rounded-[32px] p-8 text-white space-y-6 shadow-2xl shadow-slate-200 dark:shadow-none transition-colors border border-transparent dark:border-slate-800">
            <div>
              ...
              <p className="text-xs text-slate-400 font-bold leading-relaxed">
                Your account is currently protected by standard verification.
                For enhanced station security, we recommend rotating your
                passkey every 90 days.
              </p>
            </div>
            ...
            <button className="w-full flex items-center justify-between p-4 bg-white/10 hover:bg-white/20 rounded-2xl transition-all group">
              <div className="text-left">
                <p className="text-xs font-black uppercase tracking-widest mb-1 text-blue-400">
                  Passkey Rotation
                </p>
            ...
            <button className="w-full flex items-center justify-between p-4 bg-white/10 hover:bg-white/20 rounded-2xl transition-all group">
              <div className="text-left">
                <p className="text-xs font-black uppercase tracking-widest mb-1 text-amber-400">
                  Station Logs
                </p>
                <p className=" font-bold text-white/60">
                  Audit your recent actions
                </p>
              </div>
              <ArrowRight className="w-5 h-5 group-hover:translate-x-1 transition-transform" />
            </button>
          ...
          <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-100 dark:border-blue-900/30 rounded-[32px] p-8 transition-colors">
            <div className="flex items-start gap-4">
              ...
              <div>
                <p className="text-xs font-black uppercase tracking-widest text-blue-900 dark:text-blue-300 mb-2">
                  Technical Support
                </p>
                <p className=" font-bold text-blue-700/70 dark:text-blue-400/70 leading-relaxed mb-4">
                  ...
                  the DICT Support Team for priority assistance.
                </p>
                <button className=" font-black text-blue-600 dark:text-blue-400 uppercase tracking-widest hover:underline">
